...
安装及使用：https://suoha29-blip.com/xray/xray-script/
...
```
Xray script v1.21 by suoha29-blip
...
反馈问题) https://github.com/suoha29-blip/xray/issues
文档(doc) https://suoha29-blip.com/xray/xray-script/
```